(function () {
    ...
    class Pontuacao{
        constructor(){
            ...
            //Estre trecho foi modificado em relação ao trabalho Snake, para permitir uma melhor visualização na tela
            this.placar = document.createElement("pontuacao");
            this.placar.setAttribute('id','placar');
            document.getElementById("container").insertBefore(this.placar, document.getElementById("footer"));
    ...
    class Board {
        constructor() {
            ...
            container.insertBefore(this.element, document.getElementById("footer"));
    ...
    window.addEventListener("keydown", function(e){
        if(e.key === "s" && !(start)){
            if(end){//Limpa e Reinicia o Board caso o jogo já tenha acabado
                ...
                document.getElementById("placar").remove();
                init();
            }
            myVar = window.setInterval(run, 1000/FPS);
